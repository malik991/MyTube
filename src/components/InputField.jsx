...
const InputField = React.forwardRef(function Input(
  ...
  return (
    <div className="w-full text-left">
      {label && (
        <label
          className={`inline-block mb-1 pl-1 font-serif text-xl ${className}`}
          htmlFor={props.id || id}
        >
          {label}
        </label>
      ...
      {type === "textarea" ? (
        ...
        <input
          className={`px-3 py-2 rounded-lg bg-white text-black outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent border border-gray-200 w-full ${className}`}
          type={type}
          ref={ref}
          onChange={onChange}
          {...props}
